  ...
  const seedDummyData = async () => {
    ...
    try {
      ...
      const dummyCoursesList = [
        { id: '1', title: 'Standard One-Seven Foundation Mathematics', description: 'Build a strong mathematics foundation for primary and junior secondary students with structured lessons.', instructor: 'Mathenzi Edu Mentor', price: 1200, duration: '8 Weeks', lessons: 32, rating: 4.7, mainCategory: 'Academic Maths', subCategory: 'Standard One-Seven', level: 'Beginner', image: COURSE_COVER_MAP['Standard One-Seven Foundation Mathematics'], outcomes: ['Strong arithmetic and number sense', 'Basic algebra and geometry fundamentals', 'Problem solving confidence', 'Weekly practice tests'], curriculum: [{ title: 'Number Systems', lessons: 6, time: '1h 50m' }, { title: 'Basic Operations', lessons: 8, time: '2h 30m' }, { title: 'Fractions & Decimals', lessons: 6, time: '1h 45m' }] },
