...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  aboutTitle: 'About Mathemzi Edu',
  aboutIntro: 'Welcome to Mathemzi Edu. We believe in learning mathematics with logic, beauty, faith, and real-life applications.',
  ...
  contactPageTitle: 'Talk to Mathemzi Edu',
  ...
  privacyIntro: 'Mathemzi Edu collects only the account and learning information needed to provide courses, exams, support, and progress tracking.',
  ...
  termsIntro: 'By using Mathemzi Edu, learners agree to use course materials fairly, keep account access private, and follow exam rules.',
